...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="lithium-user 8.0.0 OPR1.170623.032 V9.6.1.0.OAHMIFD release-keys" \
    BuildFingerprint=Xiaomi/lithium/lithium:8.0.0/OPR1.170623.032/V9.6.1.0.OAHMIFD:user/release-keys
